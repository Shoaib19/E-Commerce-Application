...
public class Products {
    ...
    private String pname, description, price, image, category, pid, date, time,
            productState,sid, sellerAddress,sellerPhone,sellerName,sellerEmail,shortDesciption;
    ...
    public Products(String pname, String description, String price, String image, String category
            , String pid, String date, String time, String productState, String sid,String shortDesciption) {
        this.pname = pname;
